...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://godoc.org/github.com/meetcircle/dd-trace-go/ddtrace)

### Why?
This fork exists because [GORM does not properly support contexts](https://github.com/jinzhu/gorm/issues/1231).
However, there is a [fork](https://github.com/xmirya/gorm) that does. We need to link the DataDog library
against the fork to be able to use it with GORM and contexts.


### Installing

```bash
go get github.com/meetcircle/dd-trace-go/ddtrace
```
...
The API is documented on [godoc](https://godoc.org/github.com/meetcircle/dd-trace-go/ddtrace) as well as Datadog's [official documentation](https://docs.datadoghq.com/tracing/setup/go/). If you are migrating
